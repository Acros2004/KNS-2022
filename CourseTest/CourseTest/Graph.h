...
#define DATA(string) string, 5,		      \
			FST::NODE(1, FST::RELATION('d', 1)),  \
			FST::NODE(1, FST::RELATION('a', 2)),  \
			FST::NODE(1, FST::RELATION('t', 3)),  \
			FST::NODE(1, FST::RELATION('a', 4)),  \
			FST::NODE()	
#define MORE_OR_EQUAL(string) string, 3,		      \
			FST::NODE(1, FST::RELATION('>', 1)),  \
			FST::NODE(1, FST::RELATION('=', 2)),  \
			FST::NODE()	

#define LESS_OR_EQUAL(string) string, 3,		      \
			FST::NODE(1, FST::RELATION('<', 1)),  \
			FST::NODE(1, FST::RELATION('=', 2)),  \
			FST::NODE()	

#define SOURCE_FUNCTION(string) string, 7,		  \
...
#define UNSHORT(string) string, 6,			  \
...
#define STRING(string) string, 4,				  \
			FST::NODE(1, FST::RELATION('s', 1)),  \
			FST::NODE(1, FST::RELATION('t', 2)),  \
			FST::NODE(1, FST::RELATION('r', 3)),  \
			FST::NODE()

#define BOOL(string) string, 8,				  \
