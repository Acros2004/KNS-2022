...
{
	int j = 0;
	LT::LexTable NewLexTable = LT::Create(LT_MAXSIZE - 1);
	...
	PrintLexTable(NewLexTable, idtable, L"C:\\Users\\noname\\Desktop\\123\\KPO2course\\course_project\\CourseTest\\tableOfLexemWIthPolish.txt");
